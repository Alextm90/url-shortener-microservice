        ...
        if (!address) {
            ...
            // if address exists
              ...
              const original_url = url.href; 
                URLModel.findOne({original_url}).then( 
                  (objFound) => {
                    if (objFound) {
                      res.json({ original_url: objFound.original_url, short_url: objFound.short_url })
                      } else {
                        ...
                        .then((prevURL) => {          
                          ...
                          let newURL = new URLModel({ original_url: original_url, short_url: short_url }).save() 
